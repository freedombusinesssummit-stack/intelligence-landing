...
const FAQ = [
  {q:"What is the main purpose of the platform?",a:"FBS Intelligence builds and runs a dedicated lead-generation funnel for investment-migration firms. We attract, qualify, and score investor prospects — then deliver them to your dashboard ready to contact, each with a full Advisor Brief and Global Mobility Score."},
  {q:"Is this lead generation, marketing, or a business partnership?",a:"All three, structured as a partnership. We generate the leads, run the marketing (video ads + educational webinars), and operate on an exclusive basis — <strong>one partner per jurisdiction</strong>. You're not buying a list; you're getting a funnel built and run for your firm."},
  {q:"Is there a cost — during pilot and after launch?",a:"Yes. A one-time setup fee plus a monthly management fee. The setup fee covers the full funnel build and your first educational webinar. The monthly fee covers ongoing lead delivery, campaign management, and subsequent webinars."},
  {q:"What is the commercial model?",a:"Founding rate for the first 10 partners: <strong>$1,950 one-time setup</strong> + a monthly plan — Business at $499/mo or Premium at $899/mo. Two-month minimum. Founding pricing is locked for 12 months. Regular pricing after the founding cohort is $5,000 setup."},
  {q:"Do you have a brochure or written material?",a:"Yes. The <a href='/overview' style='color:var(--lime-dark);text-decoration:none;font-weight:600;'>Overview page</a> walks through the full funnel step by step, and this Pricing page details the setup breakdown and rollout timeline. On the discovery call we also share a tailored brief for your specific jurisdiction."},
  {q:"What's the difference between Business and Premium?",a:"Business delivers leads to your dashboard — your team handles all outreach and nurture. Premium adds a <strong>5-email warming sequence</strong> that FBS runs on every lead before it reaches you. By the time you call, the prospect has read educational emails and flagged themselves ready to speak with a specialist."},
  ...
  {q:"What about ad spend?",a:"Media budget is billed separately — you pay the ad platforms directly. The setup and monthly fees cover the funnel build, campaign management, and optimization, but not the paid media itself. We advise on budget during onboarding."},
  {q:"How fast do I receive first leads?",a:"The full setup takes 4–8 weeks: funnel build, then traffic testing. Your first educational webinar and first qualified leads typically arrive within 6–8 weeks of signing, covered under the setup fee."},
];
