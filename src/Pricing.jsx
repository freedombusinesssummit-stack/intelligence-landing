  ...
  return(<><style>{css}</style>
    ...
    <section className="faq-section">
      <div className="wrap">
        ...
        <h2 style={{fontSize:"clamp(26px,3.4vw,40px)",fontWeight:800,letterSpacing:"-0.03em",color:"var(--black)",marginBottom:40}}>Questions firms ask before joining FBS Intelligence.</h2>
